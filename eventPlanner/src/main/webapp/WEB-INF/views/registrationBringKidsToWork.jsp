...
<title>Registration - Bring kids to work</title>
...
<body>
	<div class="container">
		<div class="page-header">
			<h1>Bring kids to work - Registration</h1>
		</div>
				...
				<fieldset>
					...
					<div class="personaldetails">
						...
						<div class="row form-group">
							...
							<div class="col-md-3">
								<form:select id="location" class="form-control" path="location">
					...
					<div class="kidsdetails">
						<form:form class="form-horizontal well" method="POST"
							...
							<fieldset>
								...
								<div class="foreachkid">

									<div class="row">
										<h4 class="col-md-2">Child 1</h4>
									</div>

									<div class="child pull-left col-md-6">
										<div class="form-group">
											<label class="control-label col-md-4" for="childName">Name
												of the child</label>
											<div class="col-md-6">
												<form:input id="childName" class="form-control" type="text"
													path="childName" placeholder="Name of the child" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<form:input id="childAge" class="form-control" type="text"
													path="childAge" placeholder="Age of the child" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<form:radiobutton path="childGender" value="male" />
												male <br />
												<form:radiobutton path="childGender" value="female" />
												female <br />
												<form:radiobutton path="childGender"
									...
									<div class="pull-right col-md-6">
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<form:radiobutton path="isChildAllergic" value="yes" />
												Yes &nbsp;&nbsp;
												<form:radiobutton path="isChildAllergic" value="no" />
												No
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<form:textarea class="form-control" path="otherDetails"
